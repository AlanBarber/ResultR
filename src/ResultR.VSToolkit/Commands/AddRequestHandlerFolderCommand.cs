...
{
    /// <summary>
    /// Command for adding a ResultR Request/Handler from a folder context menu.
    /// This command shares the same implementation as AddRequestHandlerCommand.
    /// </summary>
    [Command(PackageIds.AddRequestHandlerFolderCommand)]
    internal sealed class AddRequestHandlerFolderCommand : BaseCommand<AddRequestHandlerFolderCommand>
    {
